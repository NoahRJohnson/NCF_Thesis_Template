...
\division{Division of Your Division}

% If the thesis is for two degrees simultaneously, list them both
% separated by \and like this:
% \degree{Doctor of Philosophy \and Master of Science}
\degree{Bachelor of Arts in Your Major \and Bachelor of Arts in Your Second Major}

\degreemonth{Month}
\degreeyear{YYYY}
\thesisdate{Month DD, YYYY}

% If there is more than one thesis sponsor,
% you'll have to go modify the ncfthesis.cls file (under \endabstractpage

\sponsor{Professor Your Sponsor}
